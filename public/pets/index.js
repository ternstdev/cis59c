...
function writeDomTable(animalCard) {
  ...
  //document.getElementById("learn-more-body").innerHTML = domTable;
  //document.getElementById("learn-more-image").innerHTML = '<div alt="' + animal.name + '" class="img-aspect hover-zoom" style="background: url(./img/' + animal.imgs[0] + '); background-size: cover; background-repeat: no-repeat;"></div>';
};
